  ...
  return (
    <section className="min-h-screen w-full bg-yellow-light relative overflow-hidden">
      ...
      <motion.div
        ...
        initial="hidden"
        animate="visible"
        className="absolute top-0 right-0 w-[40%] md:w-[30%] lg:w-auto z-0 origin-top-right scale-[1.7]"
      >
        <Image
      ...
      <motion.div
        ...
        initial="hidden"
        animate="visible"
        className="absolute pointer-events-none bottom-0 left-0 w-full sm:w-[90%] md:w-[85%] lg:w-[80%] xl:w-auto z-0 origin-bottom-left scale-[1.7]"
      >
        <Image
      ...
      <div className="container mx-auto px-4 md:px-8 xl:px-0 h-full w-full relative z-10 pt-60 lg:pt-50">
        <div className="h-full w-full md:w-[70%] lg:w-[60%] xl:w-[50%] ml-auto">
          <div className="relative">
            <motion.h1
              ...
              initial="hidden"
              animate="visible"
              className="uppercase text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-yellow-dark font-semibold leading-[1.1] tracking-tight"
            >
              Power your own <br />
              Adventure
            </motion.h1>
